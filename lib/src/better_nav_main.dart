...
import 'observable_books_app_state.dart';

class BooksAppWidget extends StatefulWidget {
  @override
  _BooksAppWidgetState createState() => _BooksAppWidgetState();
}

class _BooksAppWidgetState extends State<BooksAppWidget> {
